...
public class Rate {
    ...
    public  double ChangeFromYearLow;
    ...
    public   double ChangeFromTwoHundreddayMovingAverage;
    public  String PercentChangeFromTwoHundreddayMovingAverage;
    public  double ChangeFromFiftydayMovingAverage;
